...
namespace DoomsdayBusiness
{
  public class AllStocks : Script
  {
    ...
    public AllStocks()
    {
      ...
      UI.Notify("~p~Doomsday Heist Business~w~ Loaded, by ~g~HKH191~w~");
      this.Now = this.GetDay();
    }

    public void CheckStock() => this.InceaseGain("scripts//HKH191sBusinessMods//DoomsdayBusiness//Main.ini");

    public void InceaseGain(string iniName)
    {
    ...
    private void OnTick(object sender, EventArgs e)
    {
      ...
      if (this.GetDay() == this.NextDay && this.GetMonth() == this.NextMonth)
      {
        ...
        })
        {
          ...
          if (AllStocks.\u003C\u003Eo__40.\u003C\u003Ep__0 == null)
          {
            // ISSUE: reference to a compiler-generated field
            AllStocks.\u003C\u003Eo__40.\u003C\u003Ep__0 = CallSite<Func<CallSite, object, string>>.Create(Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (string), typeof (AllStocks)));
          }
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          string str = AllStocks.\u003C\u003Eo__40.\u003C\u003Ep__0.Target((CallSite) AllStocks.\u003C\u003Eo__40.\u003C\u003Ep__0, obj);
          if (str != null)
          {
            this.LoadIniFile2("scripts//HKH191sBusinessMods//DoomsdayBusiness//" + str);
            if (this.Config.GetValue<int>("Setup", "BuisnessLevel", this.purchaselvl) >= 1)
            {
              flag = true;
              break;
        ...
        if (num < 500)
        {
          this.DecreaseGain("scripts//HKH191sBusinessMods//DoomsdayBusiness//Main.ini");
          if (this.ShowStockIncrease)
          {
            if (!this.UseGlobalBusinessIncreaseDeceaseMessage)
              AllStocks.TextNotification("HC_N_LESTER", "~p~ Lester", "Doomsday Heist Business", "The Value of Stock has just Increased for our Doomsday Heist Business");
            if (this.UseGlobalBusinessIncreaseDeceaseMessage)
        ...
        {
          this.InceaseGain("scripts//HKH191sBusinessMods//DoomsdayBusiness//Main.ini");
          if (this.ShowStockIncrease)
          {
            if (!this.UseGlobalBusinessIncreaseDeceaseMessage)
              AllStocks.TextNotification("HC_N_LESTER", "~p~ Lester", "Doomsday Heist Business", "The Value of Stock has just Decreased for our Doomsday Heist Business");
            if (this.UseGlobalBusinessIncreaseDeceaseMessage)
              AllStocks.TextNotification("CHAR_LESTER", "~g~ Unknown", "All ~g~ HKH191's~w~ Business Mods", "The Value of Stock has just Increased/Decreased for our all Business");
          }
        }
