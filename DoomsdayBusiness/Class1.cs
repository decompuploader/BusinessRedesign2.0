...
// Type: DoomsdayBusiness.Class1
// Assembly: DoomsdayBusiness, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// MVID: 8B8008E4-22E4-48FC-8B81-6B5C57BA2FBA
// Assembly location: C:\Users\EOL\Desktop\GTA\decompiles\DoomsdayBusiness.dll
...
namespace DoomsdayBusiness
{
  public class Class1 : Script
  {
    ...
    public unsafe void OnTick(object sender, EventArgs e)
    {
      ...
      if (this.VehicleSetup2)
      {
        if (this.vehiclemissionid == 10)
        {
          ...
          if ((Entity) this.VtoGet != (Entity) null && this.VtoGet.IsAlive)
          {
            ...
            if (this.checkpointat == 2)
            {
              ...
              if (this.checkpointat == 3)
              {
                if ((double) World.GetDistance(Game.Player.Character.Position, new Vector3(514f, 4833f, -66f)) < 3.0)
                {
                  this.checkpointat = 4;
                  UI.Notify(this.GetHostName() + " You just picked up the keys for the Stromberg, get out of there, get the Strombirg");
                }
                if ((double) World.GetDistance(Game.Player.Character.Position, new Vector3(514f, 4833f, -66f)) < 10.0)
                  World.DrawMarker(MarkerType.VerticalCylinder, new Vector3(514f, 4833f, -67f), Vector3.Zero, Vector3.Zero, new Vector3(1f, 1f, 1f), Color.White);
              }
              if (this.checkpointat == 4)
              {
                this.checkpointat = 5;
                if ((Entity) this.VtoGet != (Entity) null)
                  this.VtoGet.LockStatus = VehicleLockStatus.Unlocked;
              }
              if (this.checkpointat == 5 && (Entity) this.VtoGet != (Entity) null && ((Entity) this.VtoGet.GetPedOnSeat(VehicleSeat.Driver) != (Entity) null && this.VtoGet.GetPedOnSeat(VehicleSeat.Driver).IsPlayer))
              {
                this.VtoGet.FreezePosition = false;
                this.checkpointat = 6;
              }
              if (this.checkpointat == 6 && (Entity) this.VtoGet != (Entity) null && ((Entity) this.VtoGet.GetPedOnSeat(VehicleSeat.Driver) != (Entity) null && this.VtoGet.GetPedOnSeat(VehicleSeat.Driver).IsPlayer) && (double) World.GetDistance(this.VtoGet.Position, this.Entry) < 10.0)
              {
                this.checkpointat = 7;
                if ((Entity) this.VtoGet != (Entity) null)
                  this.VtoGet.Delete();
                ...
                this.checkpointat = 0;
                Game.Player.Money += 2500000;
                UI.Notify(this.GetHostName() + " Congrats on another successfull, mission ");
              }
            }
          }
        }
        if (this.vehiclemissionid == 9)
        {
          ...
          if ((Entity) this.Bike1 != (Entity) null && !this.Bike1.IsAlive)
          {
            this.vehiclemissionid = 0;
            ...
            this.stocksvalue += 300000f;
            UI.Notify(this.GetHostName() + " Ok all Enemy vehicles have been eliminated ");
            ...
            this.Config.Save();
            this.Bike1.Delete();
            this.DeliveryVehicle.GetPedOnSeat(VehicleSeat.Driver).Delete();
            this.DeliveryVehicle.Delete();
          }
        }
      }
      ...
      {
        if (this.missionnum == 25 && ((Entity) this.Avon != (Entity) null && (Entity) this.Jugg1 != (Entity) null && (Entity) this.Jugg2 != (Entity) null))
        {
          if (!this.Avon.IsDead && !this.Jugg1.IsDead && !this.Jugg2.IsDead)
          {
            if (this.CloseTotarget && (double) World.GetDistance(Game.Player.Character.Position, this.Avon.Position) > 750.0)
            {
              if ((Entity) this.Avon != (Entity) null)
                this.Avon.Delete();
              if ((Entity) this.Jugg1 != (Entity) null)
              ...
              new MissionScreen().SetFail("Traitor to the cause", (int) this.Payout, "Avon Has escaped");
            }
            if (!this.CloseTotarget && (double) World.GetDistance(Game.Player.Character.Position, this.Avon.Position) < 150.0)
              this.CloseTotarget = true;
            if ((double) World.GetDistance(Game.Player.Character.Position, this.Avon.Position) < 150.0)
            {
              Function.Call(Hash._0xC80A74AC829DDD92, (InputArgument) this.Jugg1, (InputArgument) Function.Call<int>(Hash._0xD24D37CC275948CC, (InputArgument) "HATES_PLAYER"));
              Function.Call(Hash._0x9F7794730795E019, (InputArgument) this.Jugg1, (InputArgument) 0, (InputArgument) 0);
              Function.Call(Hash._0x9F8AA94D6D97DBF4, (InputArgument) this.Jugg1, (InputArgument) 1);
              this.Jugg1.Task.FightAgainst(Game.Player.Character);
              Function.Call(Hash._0x971D38760FBC02EF, (InputArgument) this.Jugg1, (InputArgument) 1);
              Function.Call(Hash._0xC80A74AC829DDD92, (InputArgument) this.Jugg2, (InputArgument) Function.Call<int>(Hash._0xD24D37CC275948CC, (InputArgument) "HATES_PLAYER"));
              Function.Call(Hash._0x9F7794730795E019, (InputArgument) this.Jugg2, (InputArgument) 0, (InputArgument) 0);
              Function.Call(Hash._0x9F8AA94D6D97DBF4, (InputArgument) this.Jugg2, (InputArgument) 1);
              this.Jugg2.Task.FightAgainst(Game.Player.Character);
              Function.Call(Hash._0x971D38760FBC02EF, (InputArgument) this.Jugg2, (InputArgument) 1);
              if (this.Heli.IsDead)
              {
                Function.Call(Hash._0xC80A74AC829DDD92, (InputArgument) this.Avon, (InputArgument) Function.Call<int>(Hash._0xD24D37CC275948CC, (InputArgument) "HATES_PLAYER"));
                Function.Call(Hash._0x9F7794730795E019, (InputArgument) this.Avon, (InputArgument) 0, (InputArgument) 0);
                Function.Call(Hash._0x9F8AA94D6D97DBF4, (InputArgument) this.Avon, (InputArgument) 1);
                this.Avon.Task.FightAgainst(Game.Player.Character);
                Function.Call(Hash._0x971D38760FBC02EF, (InputArgument) this.Avon, (InputArgument) 1);
              }
              if (!this.Heli.IsDead)
              {
                Function.Call(Hash._0xC80A74AC829DDD92, (InputArgument) this.Avon, (InputArgument) Function.Call<int>(Hash._0xD24D37CC275948CC, (InputArgument) "HATES_PLAYER"));
                Function.Call(Hash._0x9F7794730795E019, (InputArgument) this.Avon, (InputArgument) 0, (InputArgument) 0);
                Function.Call(Hash._0x9F8AA94D6D97DBF4, (InputArgument) this.Avon, (InputArgument) 1);
                this.Avon.Task.EnterVehicle(this.Heli, VehicleSeat.Driver);
                Function.Call(Hash._0x971D38760FBC02EF, (InputArgument) this.Avon, (InputArgument) 1);
              }
            }
            if ((Entity) this.Heli.GetPedOnSeat(VehicleSeat.Driver) != (Entity) null && (Entity) this.Heli.GetPedOnSeat(VehicleSeat.Driver) == (Entity) this.Avon)
            {
              Function.Call(Hash._0xC80A74AC829DDD92, (InputArgument) this.Avon, (InputArgument) Function.Call<int>(Hash._0xD24D37CC275948CC, (InputArgument) "HATES_PLAYER"));
              Function.Call(Hash._0x9F7794730795E019, (InputArgument) this.Avon, (InputArgument) 0, (InputArgument) 0);
              Function.Call(Hash._0x9F8AA94D6D97DBF4, (InputArgument) this.Avon, (InputArgument) 1);
              this.Avon.Task.FleeFrom(Game.Player.Character);
              Function.Call(Hash._0x971D38760FBC02EF, (InputArgument) this.Avon, (InputArgument) 1);
            }
          }
          else if (this.Avon.IsDead && this.Jugg1.IsDead && this.Jugg2.IsDead)
          {
            foreach (Prop prop in this.Props)
            {
              if ((Entity) prop != (Entity) null)
            ...
            this.missionnum = 0;
            this.MissionSetup = false;
            new MissionScreen().SetPass("Traitor to the cause", (int) this.Payout, "Avon Has escaped");
            Game.Player.Money += (int) this.Payout;
          }
        }
        if (this.missionnum == 23)
        {
          if ((uint) this.timer > 0U)
          {
            foreach (Ped guard in this.Guards)
            {
              if ((Entity) guard != (Entity) null && guard.CurrentBlip != (Blip) null && !guard.IsAlive)
                guard.CurrentBlip.Remove();
            }
            foreach (Ped guard in this.Guards)
            {
              if ((Entity) guard != (Entity) null && (double) World.GetDistance(Game.Player.Character.Position, guard.Position) < 60.0)
              {
                int num1 = Function.Call<int>(Hash._0xD24D37CC275948CC, (InputArgument) "HATES_PLAYER");
                Function.Call(Hash._0xC80A74AC829DDD92, (InputArgument) guard, (InputArgument) num1);
            ...
            if (this.NearSam)
            {
              this.DisplayHelpTextThisFrameNoSound("Time Left until chemical bomb explodes " + this.timer.ToString());
              if (this.HackingTimer != 12)
                ++this.HackingTimer;
              if (this.HackingTimer == 12)
              {
                this.HackingTimer = 0;
            ...
            Vector3 vector3_1 = new Vector3(212f, 6163f, -155f);
            Vector3 vector3_2 = new Vector3(251f, 6155f, -147f);
            Vector3 vector3_3 = new Vector3(275f, 6164f, -155f);
            if (this.IsHacking)
            {
              this.IsHacking = false;
              int num1 = new System.Random().Next(1, 100);
              if (num1 < 33)
                this.numberofHelis = 1;
              if (num1 > 33 && num1 < 66)
                this.numberofHelis = 2;
              if (num1 > 66)
                this.numberofHelis = 3;
            }
            if ((double) World.GetDistance(Game.Player.Character.Position, vector3_1) < 3.0)
              World.DrawMarker(MarkerType.VerticalCylinder, vector3_1, Vector3.Zero, Vector3.Zero, new Vector3(5f, 5f, 2f), Color.Purple);
            if ((double) World.GetDistance(Game.Player.Character.Position, vector3_2) < 3.0)
              World.DrawMarker(MarkerType.VerticalCylinder, vector3_2, Vector3.Zero, Vector3.Zero, new Vector3(5f, 5f, 2f), Color.Purple);
            if ((double) World.GetDistance(Game.Player.Character.Position, vector3_3) < 3.0)
              World.DrawMarker(MarkerType.VerticalCylinder, vector3_3, Vector3.Zero, Vector3.Zero, new Vector3(5f, 5f, 2f), Color.Purple);
            if ((double) World.GetDistance(Game.Player.Character.Position, vector3_1) < 3.0)
            {
              if (this.numberofHelis == 1)
              {
                foreach (Ped guard in this.Guards)
                {
                  if ((Entity) guard != (Entity) null)
                ...
                this.missionnum = 0;
                this.MissionSetup = false;
                new MissionScreen().SetPass("Chemical Annihlation", (int) this.Payout, "");
                Game.Player.Money += (int) this.Payout;
                UI.Notify(this.GetHostName() + " ok good weve got the checmical bomb under our control ");
                Script.Wait(2000);
                foreach (Prop prop in this.Props)
                {
                  if ((Entity) prop != (Entity) null)
              ...
              {
                this.DisplayHelpTextThisFrame("Bomb Timer has been activated, Find the real bomb fast ");
                Script.Wait(500);
                this.NearSam = true;
              }
            }
          ...
          else
          {
            ...
            new MissionScreen().SetFail("Chemical Annihlation", (int) this.Payout, "The Chemical Bomb Has Exploded");
            this.missionnum = 0;
            this.MissionSetup = false;
            ...
            if (this.numberofHelis == 1)
            {
              for (int index = 0; index < 10; ++index)
                World.ShootBullet(vector3_1, vector3_1, Game.Player.Character, model, 15000);
            }
            if (this.numberofHelis == 2)
            {
              for (int index = 0; index < 10; ++index)
                World.ShootBullet(vector3_2, vector3_2, Game.Player.Character, model, 15000);
            }
            if (this.numberofHelis == 3)
            {
              for (int index = 0; index < 10; ++index)
                World.ShootBullet(vector3_3, vector3_3, Game.Player.Character, model, 15000);
            }
            this.numberofHelis = 0;
            UI.Notify(this.GetHostName() + " Damit the chemical bomb has exploded!");
            Script.Wait(2000);
            foreach (Prop prop in this.Props)
            {
              if ((Entity) prop != (Entity) null)
        ...
        foreach (Vehicle vehicle in this.CaptureVehicle)
        {
          if ((Entity) vehicle != (Entity) null && !vehicle.IsAlive)
          {
            if ((Entity) vehicle.GetPedOnSeat(VehicleSeat.Driver) != (Entity) null)
              vehicle.GetPedOnSeat(VehicleSeat.Driver).Delete();
            if ((Entity) vehicle.GetPedOnSeat(VehicleSeat.Passenger) != (Entity) null)
              vehicle.GetPedOnSeat(VehicleSeat.Passenger).Delete();
            if ((Entity) vehicle.GetPedOnSeat(VehicleSeat.LeftRear) != (Entity) null)
              vehicle.GetPedOnSeat(VehicleSeat.LeftRear).Delete();
            if ((Entity) vehicle.GetPedOnSeat(VehicleSeat.RightRear) != (Entity) null)
              vehicle.GetPedOnSeat(VehicleSeat.RightRear).Delete();
            if (vehicle.CurrentBlip != (Blip) null)
              vehicle.CurrentBlip.Remove();
            if ((uint) this.numberofHelis > 0U)
              num8 = this.numberofHelis--;
            vehicle.Delete();
          }
        }
        if ((double) World.GetDistance(Game.Player.Character.Position, this.DropZoneVector) < 50.0)
        {
          if (this.HeliTimer != 550)
            ++this.HeliTimer;
          if (this.HeliTimer == 550 && this.numberofHelis <= this.Maxhelis)
            this.SpawnNewBarrage();
          if (this.numberofHelis > this.Maxhelis)
            this.HeliTimer = 0;
          this.DisplayHelpTextThisFrameNoSound("You need to stand in the purple marker to hack the nuclear silo, Hacking progress " + (this.HackingTimer / 100).ToString() + "/100%");
          World.DrawMarker(MarkerType.VerticalCylinder, this.DropZoneVector, Vector3.Zero, Vector3.Zero, new Vector3(50f, 50f, 6f), Color.Purple);
          if ((double) World.GetDistance(Game.Player.Character.Position, this.DropZoneVector) < 50.0)
          {
            this.IsHacking = true;
            if (this.HackingTimer != 10000)
              ++this.HackingTimer;
            if (this.HackingTimer == 10000)
            {
              this.HackingTimer = 0;
              --this.SamsTakenOut;
              UI.Notify(this.GetHostName() + " Silo under our control shutting down");
              this.missionnum = 0;
              this.MissionSetup = false;
              new MissionScreen().SetPass("Nuclear Meltdown", (int) this.Payout, "");
              Game.Player.Money += (int) this.Payout;
              UI.Notify(this.GetHostName() + " ok good we now have full controll over the Sam Array ");
              foreach (Ped guard in this.Guards)
              {
                if ((Entity) guard != (Entity) null)
                  guard.Delete();
        ...
        if (this.missionnum == 21 && ((Entity) this.CaptureVehicle[0] != (Entity) null && (Entity) this.CaptureVehicle[1] != (Entity) null && (Entity) this.CaptureVehicle[2] != (Entity) null))
        {
          foreach (Vehicle vehicle in this.CaptureVehicle)
          {
            if ((Entity) vehicle != (Entity) null)
            {
              if ((double) World.GetDistance(vehicle.Position, vehicle.Position) > 200.0)
                vehicle.IsInvincible = true;
              else if ((double) World.GetDistance(vehicle.Position, vehicle.Position) < 200.0)
                vehicle.IsInvincible = false;
            }
          }
          if (this.CaptureVehicle[0].IsAlive && this.CaptureVehicle[1].IsAlive && this.CaptureVehicle[2].IsAlive)
          {
            if ((uint) this.SamsTakenOut > 0U)
            {
              foreach (Ped guard in this.Guards)
              {
                if ((Entity) guard != (Entity) null)
              ...
              foreach (Vehicle vehicle in this.CaptureVehicle)
              {
                if ((Entity) vehicle != (Entity) null && vehicle.PearlescentColor == VehicleColor.Blue && (double) World.GetDistance(vehicle.Position, this.DropZoneVector) < 3.0)
                {
                  --this.SamsTakenOut;
                  vehicle.PearlescentColor = VehicleColor.MatteBlack;
                  if (this.SamsTakenOut == 2)
                  {
                    Game.Player.Character.Task.LeaveVehicle(LeaveVehicleFlags.WarpOut);
                    Script.Wait(500);
                    vehicle.Position = new Vector3(2820f, -631f, 6f);
                    vehicle.Rotation = new Vector3(0.0f, 0.0f, 0.0f);
                  }
                  if (this.SamsTakenOut == 1)
                  {
                    Game.Player.Character.Task.LeaveVehicle(LeaveVehicleFlags.WarpOut);
                    Script.Wait(500);
                    vehicle.Position = new Vector3(2820f, -638f, 6f);
                    vehicle.Rotation = new Vector3(0.0f, 0.0f, 0.0f);
                  }
                }
              }
              if ((double) World.GetDistance(Game.Player.Character.Position, this.DropZoneVector) < 40.0)
                this.DisplayHelpTextThisFrame("Bring All three Strombergs on the Barges, to the Drop Zone");
              World.DrawMarker(MarkerType.VerticalCylinder, this.DropZoneVector, Vector3.Zero, Vector3.Zero, new Vector3(4f, 4f, 3f), Color.Purple);
              if ((double) World.GetDistance(Game.Player.Character.Position, this.DropZoneVector) < 4.0)
                this.DisplayHelpTextThisFrame("Bring a Stromberg to here to deliver it");
            }
            else
            {
              foreach (Ped guard in this.Guards)
              ...
              this.missionnum = 0;
              this.MissionSetup = false;
              new MissionScreen().SetPass("Storming The Barge", (int) this.Payout, "");
              Game.Player.Money += (int) this.Payout;
              UI.Notify(this.GetHostName() + " ok good we possestion of all three strombergs we can get out of here");
            }
          }
          else
          {
            ...
            this.missionnum = 0;
            this.MissionSetup = false;
            UI.Notify(this.GetHostName() + " Damit!, one or more of the Strombergs was destroyed, we will have to try this heist again sometime");
          }
        }
        if (this.missionnum == 20)
        {
          if ((uint) this.SamsTakenOut > 0U)
          {
            foreach (Vehicle vehicle in this.CaptureVehicle)
            ...
            for (int index = 0; index < this.SamPoints.Count; ++index)
            {
              Vector3 samPoint = this.SamPoints[index];
              if (true)
              {
                if (this.SamBips[index] != (Blip) null && ((double) World.GetDistance(Game.Player.Character.Position, this.SamPoints[index]) < 400.0 && this.SamBips[index].Color == BlipColor.Purple))
                {
                  if ((Entity) Game.Player.Character.CurrentVehicle != (Entity) null)
                  {
                    Vehicle currentVehicle = Game.Player.Character.CurrentVehicle;
                    if (currentVehicle.ClassType == VehicleClass.Helicopters || currentVehicle.ClassType == VehicleClass.Planes)
                    {
                      if (this.MissileTimer != 450)
                        ++this.MissileTimer;
                      if (this.MissileTimer == 450)
                      {
                        Model model = (Model) Function.Call<int>(Hash._0xD24D37CC275948CC, (InputArgument) "WEAPON_AIRSTRIKE_ROCKET");
                        ...
                        Vector3 sourcePosition = this.SamPoints[index];
                        sourcePosition = new Vector3(sourcePosition.X, sourcePosition.Y, sourcePosition.Z += 3f);
                        World.ShootBullet(sourcePosition, Game.Player.Character.Position, Game.Player.Character, model, 15000);
                        this.MissileTimer = 0;
                      }
                    }
                  }
                  if (this.HeliTimer != 750)
                    ++this.HeliTimer;
                  if (this.HeliTimer == 750 && this.numberofHelis <= this.Maxhelis)
                  {
                    ++this.numberofHelis;
                    Vector3 position = Game.Player.Character.Position;
                    Ped character = Game.Player.Character;
                    System.Random random = new System.Random();
                    int num1 = random.Next(-1750, 1750);
                    int num2 = random.Next(-1750, 1750);
                    Vehicle vehicle = World.CreateVehicle((Model) VehicleHash.Buzzard, new Vector3(position.X + (float) num1, position.Y + (float) num2, position.Z));
                ...
                if (this.SamBips[index] != (Blip) null && ((double) World.GetDistance(Game.Player.Character.Position, this.SamPoints[index]) < 20.0 && this.SamBips[index].Color == BlipColor.Purple))
                {
                  this.DisplayHelpTextThisFrameNoSound("You need to stand in the purple marker to hack the sam battey, Hacking progress " + (this.HackingTimer / 10).ToString() + "/100%");
                  World.DrawMarker(MarkerType.VerticalCylinder, this.SamPoints[index], Vector3.Zero, Vector3.Zero, new Vector3(4f, 4f, 3f), Color.Purple);
                  if ((double) World.GetDistance(Game.Player.Character.Position, this.SamPoints[index]) < 4.0 && this.SamBips[index].Color == BlipColor.Purple)
                  {
                    this.IsHacking = true;
                    if (this.HackingTimer != 1000)
                      ++this.HackingTimer;
                    if (this.HackingTimer == 1000)
                    {
                      this.SamBips[index].Color = BlipColor.White;
                      this.SamBips[index].Remove();
                      this.HackingTimer = 0;
                      --this.SamsTakenOut;
                      UI.Notify(this.GetHostName() + " Another Sam battery successfuly shut down, find the rest!");
                    }
                  }
                  else
                    this.IsHacking = false;
          ...
          else if (this.SamsTakenOut == 0)
          {
            ...
            this.missionnum = 0;
            this.MissionSetup = false;
            new MissionScreen().SetPass("Taking The Mountain", (int) this.Payout, "");
            Game.Player.Money += (int) this.Payout;
            UI.Notify(this.GetHostName() + " ok good we now have full controll over the Sam Array ");
          }
        }
        ...
        {
          if (this.triggerWeaponizedCargo2)
          {
            if (this.timer == 25)
            {
              this.timer = 0;
              if (!this.iscloaked)
              {
                ...
                {
                  this.Sam1.GetPedOnSeat(VehicleSeat.Driver).CanBeTargetted = false;
                  this.Sam1blip.Remove();
                  this.Sam1.GetPedOnSeat(VehicleSeat.Driver).IsVisible = false;
                  this.Sam1.Alpha = 220;
                  Script.Wait(50);
                  this.Sam1.Alpha = 200;
                  Script.Wait(50);
                  ...
                  Script.Wait(50);
                  this.Sam1.Alpha = 40;
                  UI.Notify(this.GetHostName() + " Target vehicle Just Cloaked ");
                }
              }
              else if (this.iscloaked)
              {
                ...
                if ((Entity) this.Sam1 != (Entity) null && this.Sam1.IsAlive)
                {
                  ...
                  this.Sam1.Alpha = 200;
                  Script.Wait(50);
                  this.Sam1.Alpha = (int) byte.MaxValue;
                  this.Sam1.GetPedOnSeat(VehicleSeat.Driver).IsVisible = true;
                  UI.Notify(this.GetHostName() + " Target vehicle Just De-Cloaked ");
                  this.Sam1blip = World.CreateBlip(this.Sam1.Position);
                  this.Sam1blip.Sprite = BlipSprite.SportsCar;
                  this.Sam1blip.Color = BlipColor.Red;
                  this.Sam1blip.Name = "Vehicle A";
                  this.Sam1.GetPedOnSeat(VehicleSeat.Driver).CanBeTargetted = true;
                }
              }
            }
            if (this.timer != 25)
          ...
          if ((double) World.GetDistance(this.Sam1.Position, this.EndPoint) < 20.0)
          {
            Game.FadeScreenOut(500);
            Script.Wait(500);
            this.EndPointBlip.Remove();
            ...
            if (this.Sam3blip != (Blip) null)
              this.Sam3blip.Remove();
            Function.Call(Hash._0x1268615ACE24D504, (InputArgument) false);
            Script.Wait(500);
            Game.FadeScreenIn(500);
            UI.Notify(this.GetHostName() + " Boss a vehicle Reached the destination!, We cannot aford to have the millitary come after us!");
            this.MissionSetup = false;
        ...
        {
          if ((double) World.GetDistance(Game.Player.Character.Position, this.Sam1.Position) < 900.0 && this.triggerWeaponizedCargo)
          {
            UI.Notify(this.GetHostName() + " Boss that vehicle just triggered a EMP!, all electornics are dead!");
            this.Sam1.GetPedOnSeat(VehicleSeat.Driver).Task.DriveTo(this.Sam1, this.EndPoint, 20f, 170f, 786468);
            this.Sam1.GetPedOnSeat(VehicleSeat.Driver).CanBeTargetted = false;
            this.triggerWeaponizedCargo = false;
            if (this.Sam1blip != (Blip) null)
              this.Sam1blip.Remove();
            Function.Call(Hash._0x1268615ACE24D504, (InputArgument) true);
            if ((Entity) Game.Player.Character.CurrentVehicle != (Entity) null)
            {
              Game.Player.Character.CurrentVehicle.IsDriveable = false;
              Game.Player.Character.CurrentVehicle.Health = 10;
              Script.Wait(2000);
              Game.Player.Character.CurrentVehicle.Health = 100;
        ...
        {
          if ((Entity) this.Sam1 != (Entity) null && this.Sam1.IsAlive && (this.Sam1.DisplayName == "CHERNOBOG" && (double) World.GetDistance(Game.Player.Character.Position, this.Sam1.Position) < 600.0))
            this.FireMissile(this.Sam1.Position, this.Sam1.GetPedOnSeat(VehicleSeat.Driver));
          if ((Entity) this.Sam2 != (Entity) null && this.Sam2.IsAlive && (this.Sam2.DisplayName == "CHERNOBOG" && (double) World.GetDistance(Game.Player.Character.Position, this.Sam2.Position) < 600.0))
            this.FireMissile(this.Sam2.Position, this.Sam2.GetPedOnSeat(VehicleSeat.Driver));
          if ((Entity) this.Sam3 != (Entity) null && this.Sam3.IsAlive && (this.Sam3.DisplayName == "CHERNOBOG" && (double) World.GetDistance(Game.Player.Character.Position, this.Sam3.Position) < 600.0))
            this.FireMissile(this.Sam3.Position, this.Sam3.GetPedOnSeat(VehicleSeat.Driver));
          if (!this.Sam1.IsAlive && this.Sam1blip != (Blip) null)
            this.Sam1blip.Remove();
          if (!this.Sam2.IsAlive && this.Sam2blip != (Blip) null)
            this.Sam2blip.Remove();
          if (!this.Sam3.IsAlive && this.Sam3blip != (Blip) null)
            this.Sam3blip.Remove();
          if (!this.Sam1.IsAlive && !this.Sam2.IsAlive && !this.Sam3.IsAlive)
          {
            Game.FadeScreenOut(500);
        ...
        if ((Entity) this.EnemyV != (Entity) null)
        {
          if ((double) World.GetDistance(Game.Player.Character.Position, this.EnemyV.Position) < 500.0)
          {
            this.EnemyV.IsInvincible = false;
            this.EnemyV.IsVisible = true;
          }
          if (this.missionnum == 1)
            this.EnemyVehicleBLip.Position = this.EnemyV.Position;
          if (!this.EnemyV.IsAlive && this.missionnum == 1)
          {
            Game.FadeScreenOut(500);
            Script.Wait(500);
            if (this.EnemyVehicleBLip != (Blip) null)
              this.EnemyVehicleBLip.Remove();
            if ((Entity) this.EnemyV != (Entity) null)
              this.EnemyV.Delete();
            Script.Wait(500);
            Game.FadeScreenIn(500);
      ...
      if (this.GotVehicle)
      {
        this.MillitaryAsset.Position = this.VehicleToGet.Position;
        if (this.VehicleToGet.IsAlive)
        {
          if ((double) World.GetDistance(Game.Player.Character.Position, this.Entry) < 50.0 && (Entity) Game.Player.Character.CurrentVehicle != (Entity) null && (Entity) Game.Player.Character.CurrentVehicle == (Entity) this.VehicleToGet)
          {
            Game.FadeScreenOut(300);
            Script.Wait(300);
            if (this.VehicleToGet.DisplayName == "THRUSTER")
            {
              this.ThrusterBought = 1;
              this.Config.SetValue<int>("SpecialVehicles", "ThrusterBought", this.ThrusterBought);
              this.Config.Save();
            ...
            if (this.VehicleToGet.DisplayName == "AVENGER")
            {
              this.AvengerBought = 1;
              this.Config.SetValue<int>("SpecialVehicles", "AvengerBought", this.AvengerBought);
              this.Config.Save();
            ...
            if (this.VehicleToGet.DisplayName == "BARRAGE")
            {
              this.BarrageBought = 1;
              this.Config.SetValue<int>("SpecialVehicles", "BarrageBought", this.BarrageBought);
              this.Config.Save();
            ...
            if (this.VehicleToGet.DisplayName == "CHERNOBOG")
            {
              this.ChernobogBought = 1;
              this.Config.SetValue<int>("SpecialVehicles", "ChernobogBought", this.ChernobogBought);
              this.Config.Save();
            ...
            if (this.VehicleToGet.DisplayName == "DELUXO")
            {
              this.DeluxoBought = 1;
              this.Config.SetValue<int>("SpecialVehicles", "DeluxoBought", this.DeluxoBought);
              this.Config.Save();
            ...
            if (this.VehicleToGet.DisplayName == "STROMBERG")
            {
              this.StrombergBought = 1;
              this.Config.SetValue<int>("SpecialVehicles", "StrombergBought", this.StrombergBought);
              this.Config.Save();
            ...
            if (this.VehicleToGet.DisplayName == "KHANJALI")
            {
              this.KhanjaliBought = 1;
              this.Config.SetValue<int>("SpecialVehicles", "KhanjaliBought", this.KhanjaliBought);
              this.Config.Save();
            ...
            if (this.VehicleToGet.DisplayName == "AKULA")
            {
              this.AkulaBought = 1;
              this.Config.SetValue<int>("SpecialVehicles", "AkulaBought", this.AkulaBought);
              this.Config.Save();
            ...
            Script.Wait(300);
            Game.FadeScreenIn(300);
            this.stocksvalue += (float) random.Next(25000, 125000);
            UI.Notify(this.GetHostName() + " ok good vehicle delivered, Stocks have increased");
            UI.Notify("Max Stocks: " + this.maxstocks.ToString());
            UI.Notify("Max Stocks: " + this.maxstocks.ToString());
            UI.Notify("Annual Gain: $" + this.increaseGain.ToString("N"));
            UI.Notify("Mission Gain: " + this.profitMargin.ToString() + "%");
      ...
      if (!this.isInInterior || !((Entity) Game.Player.Character.CurrentVehicle != (Entity) null) || !this.createdVehicles)
        return;
      Vehicle currentVehicle3 = Game.Player.Character.CurrentVehicle;
      if ((Entity) this.ThrusterV != (Entity) null && (Entity) currentVehicle3 == (Entity) this.ThrusterV)
        this.DisplayHelpTextThisFrame("Press  ~INPUT_CONTEXT~  to Use Vehicle, Press ~INPUT_COVER~  to Save Vehicle");
      if ((Entity) this.ChernobogV != (Entity) null && (Entity) currentVehicle3 == (Entity) this.ChernobogV)
        this.DisplayHelpTextThisFrame("Press  ~INPUT_CONTEXT~  to Use Vehicle, Press ~INPUT_COVER~  to Save Vehicle");
      if ((Entity) this.KhanjalIV != (Entity) null && (Entity) currentVehicle3 == (Entity) this.KhanjalIV)
        this.DisplayHelpTextThisFrame("Press  ~INPUT_CONTEXT~  to Use Vehicle, Press ~INPUT_COVER~  to Save Vehicle");
      if ((Entity) this.AvengerV != (Entity) null && (Entity) currentVehicle3 == (Entity) this.AvengerV)
        this.DisplayHelpTextThisFrame("Press  ~INPUT_CONTEXT~  to Use Vehicle, Press ~INPUT_COVER~  to Save Vehicle");
      if ((Entity) this.AkulaV != (Entity) null && (Entity) currentVehicle3 == (Entity) this.AkulaV)
        this.DisplayHelpTextThisFrame("Press  ~INPUT_CONTEXT~  to Use Vehicle, Press ~INPUT_COVER~  to Save Vehicle");
      if ((Entity) this.BarrageV != (Entity) null && (Entity) currentVehicle3 == (Entity) this.BarrageV)
        this.DisplayHelpTextThisFrame("Press  ~INPUT_CONTEXT~  to Use Vehicle, Press ~INPUT_COVER~  to Save Vehicle");
      if ((Entity) this.StrombergV != (Entity) null && (Entity) currentVehicle3 == (Entity) this.StrombergV)
        this.DisplayHelpTextThisFrame("Press  ~INPUT_CONTEXT~  to Use Vehicle, Press ~INPUT_COVER~  to Save Vehicle");
      if ((Entity) this.DeluxoV != (Entity) null && (Entity) currentVehicle3 == (Entity) this.DeluxoV)
        this.DisplayHelpTextThisFrame("Press  ~INPUT_CONTEXT~  to Use Vehicle, Press ~INPUT_COVER~  to Save Vehicle");
    }
    ...
    private void SetupWeapons()
    {
      ...
      UIMenu uiMenu1 = this.MVmodMenuPool.AddSubMenu(this.weaponsMenu, "Mk2 Weapons (Advanced)");
      this.GUIMenus.Add(uiMenu1);
      ...
      uiMenu1.OnListChange += (ListChangedEvent) ((sender, item, index) =>
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__1 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__1 = CallSite<Func<CallSite, object, bool>>.Create(Binder.UnaryOperation(CSharpBinderFlags.None, ExpressionType.IsTrue, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[1]
            {
              CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
            }));
          }
          // ISSUE: reference to a compiler-generated field
          Func<CallSite, object, bool> target1 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__1.Target;
          // ISSUE: reference to a compiler-generated field
          CallSite<Func<CallSite, object, bool>> p1 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__1;
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__0 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__0 = CallSite<Func<CallSite, WeaponCollection, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "HasWeapon", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[2]
            {
              CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, (string) null),
              CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
            }));
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          object obj1 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__0.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__0, Game.Player.Character.Weapons, Mk2Weapons[W.Index]);
          if (target1((CallSite) p1, obj1))
          {
            Components.Clear();
            // ISSUE: reference to a compiler-generated field
            if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__2 == null)
            {
              // ISSUE: reference to a compiler-generated field
              Class1.\u003C\u003Eo__477.\u003C\u003Ep__2 = CallSite<Action<CallSite, WeaponCollection, object, bool>>.Create(Binder.InvokeMember(CSharpBinderFlags.ResultDiscarded, "Select", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[3]
              {
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, (string) null),
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null),
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType | CSharpArgumentInfoFlags.Constant, (string) null)
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__2.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__2, Game.Player.Character.Weapons, Mk2Weapons[W.Index], true);
          ...
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__4 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__4 = CallSite<Func<CallSite, object, string>>.Create(Binder.Convert(CSharpBinderFlags.None, typeof (string), typeof (Class1)));
          }
          // ISSUE: reference to a compiler-generated field
          Func<CallSite, object, string> target2 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__4.Target;
          // ISSUE: reference to a compiler-generated field
          CallSite<Func<CallSite, object, string>> p4 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__4;
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__3 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__3 = CallSite<Func<CallSite, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "ToString", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[1]
            {
              CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
            }));
          }
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          object obj2 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__3.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__3, Components[C.Index]);
        ...
        if (item != C)
          return;
        // ISSUE: reference to a compiler-generated field
        if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__6 == null)
        {
          // ISSUE: reference to a compiler-generated field
          Class1.\u003C\u003Eo__477.\u003C\u003Ep__6 = CallSite<Func<CallSite, object, string>>.Create(Binder.Convert(CSharpBinderFlags.None, typeof (string), typeof (Class1)));
        }
        // ISSUE: reference to a compiler-generated field
        Func<CallSite, object, string> target = Class1.\u003C\u003Eo__477.\u003C\u003Ep__6.Target;
        // ISSUE: reference to a compiler-generated field
        CallSite<Func<CallSite, object, string>> p6 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__6;
        // ISSUE: reference to a compiler-generated field
        if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__5 == null)
        {
          // ISSUE: reference to a compiler-generated field
          Class1.\u003C\u003Eo__477.\u003C\u003Ep__5 = CallSite<Func<CallSite, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "ToString", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[1]
          {
            CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
          }));
        }
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        object obj = Class1.\u003C\u003Eo__477.\u003C\u003Ep__5.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__5, Components[C.Index]);
      ...
      uiMenu1.OnItemSelect += (ItemSelectEvent) ((sender, item, index) =>
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__8 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__8 = CallSite<Func<CallSite, object, string>>.Create(Binder.Convert(CSharpBinderFlags.None, typeof (string), typeof (Class1)));
          }
          // ISSUE: reference to a compiler-generated field
          Func<CallSite, object, string> target1 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__8.Target;
          // ISSUE: reference to a compiler-generated field
          CallSite<Func<CallSite, object, string>> p8 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__8;
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__7 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__7 = CallSite<Func<CallSite, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "ToString", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[1]
            {
              CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
            }));
          }
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          object obj1 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__7.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__7, Components[C.Index]);
          ...
          if ((double) Game.Player.Money >= (double) CPrice)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__10 == null)
            {
              // ISSUE: reference to a compiler-generated field
              Class1.\u003C\u003Eo__477.\u003C\u003Ep__10 = CallSite<Func<CallSite, object, bool>>.Create(Binder.UnaryOperation(CSharpBinderFlags.None, ExpressionType.IsTrue, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[1]
              {
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
              }));
            }
            // ISSUE: reference to a compiler-generated field
            Func<CallSite, object, bool> target2 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__10.Target;
            // ISSUE: reference to a compiler-generated field
            CallSite<Func<CallSite, object, bool>> p10 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__10;
            // ISSUE: reference to a compiler-generated field
            if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__9 == null)
            {
              // ISSUE: reference to a compiler-generated field
              Class1.\u003C\u003Eo__477.\u003C\u003Ep__9 = CallSite<Func<CallSite, WeaponCollection, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "HasWeapon", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[2]
              {
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, (string) null),
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
              }));
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            object obj2 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__9.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__9, Game.Player.Character.Weapons, Mk2Weapons[W.Index]);
            if (target2((CallSite) p10, obj2))
            {
              ...
              {
                // ISSUE: reference to a compiler-generated field
                if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__11 == null)
                {
                  // ISSUE: reference to a compiler-generated field
                  Class1.\u003C\u003Eo__477.\u003C\u003Ep__11 = CallSite<Action<CallSite, WeaponCollection, object, bool>>.Create(Binder.InvokeMember(CSharpBinderFlags.ResultDiscarded, "Select", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[3]
                  {
                    CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, (string) null),
                    CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null),
                    CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType | CSharpArgumentInfoFlags.Constant, (string) null)
                ...
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                Class1.\u003C\u003Eo__477.\u003C\u003Ep__11.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__11, Game.Player.Character.Weapons, Mk2Weapons[W.Index], true);
                // ISSUE: reference to a compiler-generated field
                if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__12 == null)
                {
                  // ISSUE: reference to a compiler-generated field
                  Class1.\u003C\u003Eo__477.\u003C\u003Ep__12 = CallSite<Action<CallSite, Weapon, object, bool>>.Create(Binder.InvokeMember(CSharpBinderFlags.ResultDiscarded, "SetComponent", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[3]
                  {
                    CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, (string) null),
                    CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null),
                    CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType | CSharpArgumentInfoFlags.Constant, (string) null)
                ...
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                Class1.\u003C\u003Eo__477.\u003C\u003Ep__12.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__12, Game.Player.Character.Weapons.Current, Components[C.Index], true);
              }
            }
          }
        }
        if (item != DIsable)
          return;
        // ISSUE: reference to a compiler-generated field
        if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__14 == null)
        {
          // ISSUE: reference to a compiler-generated field
          Class1.\u003C\u003Eo__477.\u003C\u003Ep__14 = CallSite<Func<CallSite, object, bool>>.Create(Binder.UnaryOperation(CSharpBinderFlags.None, ExpressionType.IsTrue, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[1]
          {
            CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
          }));
        }
        // ISSUE: reference to a compiler-generated field
        Func<CallSite, object, bool> target3 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__14.Target;
        // ISSUE: reference to a compiler-generated field
        CallSite<Func<CallSite, object, bool>> p14 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__14;
        // ISSUE: reference to a compiler-generated field
        if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__13 == null)
        {
          // ISSUE: reference to a compiler-generated field
          Class1.\u003C\u003Eo__477.\u003C\u003Ep__13 = CallSite<Func<CallSite, WeaponCollection, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "HasWeapon", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[2]
          {
            CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, (string) null),
            CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
          }));
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        object obj3 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__13.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__13, Game.Player.Character.Weapons, Mk2Weapons[W.Index]);
        if (target3((CallSite) p14, obj3))
        {
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__19 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__19 = CallSite<Func<CallSite, object, bool>>.Create(Binder.UnaryOperation(CSharpBinderFlags.None, ExpressionType.IsTrue, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[1]
            {
              CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
            }));
          }
          // ISSUE: reference to a compiler-generated field
          Func<CallSite, object, bool> target1 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__19.Target;
          // ISSUE: reference to a compiler-generated field
          CallSite<Func<CallSite, object, bool>> p19 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__19;
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__18 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__18 = CallSite<Func<CallSite, object, bool, object>>.Create(Binder.BinaryOperation(CSharpBinderFlags.None, ExpressionType.Equal, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[2]
            {
              CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null),
              CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType | CSharpArgumentInfoFlags.Constant, (string) null)
            }));
          ...
          // ISSUE: reference to a compiler-generated field
          Func<CallSite, object, bool, object> target2 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__18.Target;
          // ISSUE: reference to a compiler-generated field
          CallSite<Func<CallSite, object, bool, object>> p18 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__18;
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__17 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__17 = CallSite<Func<CallSite, System.Type, Hash, object, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "Call", (IEnumerable<System.Type>) new System.Type[1]
            {
              typeof (bool)
          ...
          // ISSUE: reference to a compiler-generated field
          Func<CallSite, System.Type, Hash, object, object, object> target4 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__17.Target;
          // ISSUE: reference to a compiler-generated field
          CallSite<Func<CallSite, System.Type, Hash, object, object, object>> p17 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__17;
          System.Type type = typeof (Function);
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__15 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__15 = CallSite<Func<CallSite, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "GetHashCode", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[1]
            {
              CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
            }));
          }
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          object obj1 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__15.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__15, Mk2Weapons[W.Index]);
          // ISSUE: reference to a compiler-generated field
          if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__16 == null)
          {
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__16 = CallSite<Func<CallSite, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "GetHashCode", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[1]
            {
              CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null)
            }));
          }
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          object obj2 = Class1.\u003C\u003Eo__477.\u003C\u003Ep__16.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__16, Components[C.Index]);
          ...
          {
            // ISSUE: reference to a compiler-generated field
            if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__20 == null)
            {
              // ISSUE: reference to a compiler-generated field
              Class1.\u003C\u003Eo__477.\u003C\u003Ep__20 = CallSite<Action<CallSite, WeaponCollection, object, bool>>.Create(Binder.InvokeMember(CSharpBinderFlags.ResultDiscarded, "Select", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[3]
              {
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, (string) null),
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null),
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType | CSharpArgumentInfoFlags.Constant, (string) null)
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__20.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__20, Game.Player.Character.Weapons, Mk2Weapons[W.Index], true);
            // ISSUE: reference to a compiler-generated field
            if (Class1.\u003C\u003Eo__477.\u003C\u003Ep__21 == null)
            {
              // ISSUE: reference to a compiler-generated field
              Class1.\u003C\u003Eo__477.\u003C\u003Ep__21 = CallSite<Action<CallSite, Weapon, object, bool>>.Create(Binder.InvokeMember(CSharpBinderFlags.ResultDiscarded, "SetComponent", (IEnumerable<System.Type>) null, typeof (Class1), (IEnumerable<CSharpArgumentInfo>) new CSharpArgumentInfo[3]
              {
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, (string) null),
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, (string) null),
                CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType | CSharpArgumentInfoFlags.Constant, (string) null)
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            Class1.\u003C\u003Eo__477.\u003C\u003Ep__21.Target((CallSite) Class1.\u003C\u003Eo__477.\u003C\u003Ep__21, Game.Player.Character.Weapons.Current, Components[C.Index], false);
          }
        }
      });
      UIMenu uiMenu2 = this.MVmodMenuPool.AddSubMenu(this.weaponsMenu, "Scifi Weapons");
      this.GUIMenus.Add(uiMenu2);
      UIMenu menu = this.MVmodMenuPool.AddSubMenu(this.weaponsMenu, "Mk2 Weapons");
      this.GUIMenus.Add(menu);
      UIMenu uiMenu3 = this.MVmodMenuPool.AddSubMenu(this.weaponsMenu, "Normal Weapons");
      this.GUIMenus.Add(uiMenu3);
      List<object> items3 = new List<object>();
      for (int index = 0; index < this.Tintscount; ++index)
        items3.Add((object) index);
      this.MK2Pumpshotgun = this.MVmodMenuPool.AddSubMenu(menu, "MK2 Pump Shotgun");
      this.GUIMenus.Add(this.MK2Pumpshotgun);
      this.MK2SNSPistol = this.MVmodMenuPool.AddSubMenu(menu, "MK2 SNS Pistol");
      this.GUIMenus.Add(this.MK2SNSPistol);
      this.MK2Revolver = this.MVmodMenuPool.AddSubMenu(menu, "MK2 Revolver");
      this.GUIMenus.Add(this.MK2Revolver);
      this.Mk2SpecialCarbine = this.MVmodMenuPool.AddSubMenu(menu, "MK2 Special Carbine");
      this.GUIMenus.Add(this.Mk2SpecialCarbine);
      this.MK2Bullpup = this.MVmodMenuPool.AddSubMenu(menu, "MK2 Bullpup Rifle");
      this.GUIMenus.Add(this.MK2Bullpup);
      this.MK2MarksmanRifle = this.MVmodMenuPool.AddSubMenu(menu, "MK2 Marksmans Rifle");
      this.GUIMenus.Add(this.MK2MarksmanRifle);
      this.MK2Pistol = this.MVmodMenuPool.AddSubMenu(menu, "MK2 Pistol");
      this.GUIMenus.Add(this.MK2Pistol);
      this.MK2SMG = this.MVmodMenuPool.AddSubMenu(menu, "MK2 SMG");
      this.GUIMenus.Add(this.MK2SMG);
      this.MK2LMG = this.MVmodMenuPool.AddSubMenu(menu, "MK2 LMG");
      this.GUIMenus.Add(this.MK2LMG);
      this.MK2Carbine = this.MVmodMenuPool.AddSubMenu(menu, "MK2 Carbine");
      this.GUIMenus.Add(this.MK2Carbine);
      this.MK2AssaultRifle = this.MVmodMenuPool.AddSubMenu(menu, "MK2 Assault Rifle");
      this.GUIMenus.Add(this.MK2AssaultRifle);
      this.MK2Sniper = this.MVmodMenuPool.AddSubMenu(menu, "MK2 Sniper");
    ...
    {
      if (Game.IsControlJustPressed(2, GTA.Control.Context) && ((this.Config.GetValue<int>("Extra", "GunLockerBought", this.GunLockerBought) == 1 || this.GunLockerBought == 1) && (double) World.GetDistance(Game.Player.Character.Position, this.GunLockerMarker) < 2.0 && !this.MVmainMenu.Visible))
        this.MVmainMenu.Visible = !this.MVmainMenu.Visible;
      if ((Entity) Game.Player.Character.CurrentVehicle != (Entity) null && this.createdVehicles)
      {
        Vehicle currentVehicle = Game.Player.Character.CurrentVehicle;
        if ((Entity) this.ThrusterV != (Entity) null && (Entity) currentVehicle == (Entity) this.ThrusterV)
        {
          if (Game.IsControlJustPressed(2, GTA.Control.Context))
          {
            ...
            this.SC.LoadIniFile("scripts//HKH191sBusinessMods//DoomsdayBusiness//FacilityStorage//Thruster.ini");
            this.SC.SaveWithoutDelete();
            this.VehicleInUse = Game.Player.Character.CurrentVehicle;
            Game.Player.Character.CurrentVehicle.Position = this.OutsideSpawn;
            this.isInInterior = false;
            Game.Player.Character.SetIntoVehicle(this.VehicleInUse, VehicleSeat.Driver);
            this.VehicleInUse.IsDriveable = true;
            this.VehicleInUse.IsInvincible = false;
            this.ThrusterV = (Vehicle) null;
            this.DeleteVehicles();
            Script.Wait(1500);
        ...
        if ((Entity) this.ChernobogV != (Entity) null && (Entity) currentVehicle == (Entity) this.ChernobogV)
        {
          if (Game.IsControlJustPressed(2, GTA.Control.Context))
          {
            Game.FadeScreenOut(800);
        ...
        if ((Entity) this.KhanjalIV != (Entity) null && (Entity) currentVehicle == (Entity) this.KhanjalIV)
        {
          if (Game.IsControlJustPressed(2, GTA.Control.Context))
          {
            Game.FadeScreenOut(800);
        ...
        if ((Entity) this.AvengerV != (Entity) null && (Entity) currentVehicle == (Entity) this.AvengerV)
        {
          if (Game.IsControlJustPressed(2, GTA.Control.Context))
          {
            Game.FadeScreenOut(800);
            ...
            this.isInInterior = false;
            this.Entry.Z += 5f;
            Game.Player.Character.Position = new Vector3(505f, 505f, 2505f);
            Script.Wait(50);
            this.DeleteVehicles();
            Script.Wait(1500);
            Game.FadeScreenIn(800);
        ...
        if ((Entity) this.AkulaV != (Entity) null && (Entity) currentVehicle == (Entity) this.AkulaV)
        {
          if (Game.IsControlJustPressed(2, GTA.Control.Context))
          {
            Game.FadeScreenOut(800);
        ...
        if ((Entity) this.BarrageV != (Entity) null && (Entity) currentVehicle == (Entity) this.BarrageV)
        {
          if (Game.IsControlJustPressed(2, GTA.Control.Context))
          {
            Game.FadeScreenOut(800);
        ...
        if ((Entity) this.StrombergV != (Entity) null && (Entity) currentVehicle == (Entity) this.StrombergV)
        {
          if (Game.IsControlJustPressed(2, GTA.Control.Context))
          {
            Game.FadeScreenOut(800);
        ...
        if ((Entity) this.DeluxoV != (Entity) null && (Entity) currentVehicle == (Entity) this.DeluxoV)
        {
          if (Game.IsControlJustPressed(2, GTA.Control.Context))
          {
            Game.FadeScreenOut(800);
      ...
      if (Game.IsControlJustPressed(2, GTA.Control.Context) && (Entity) this.ClosedHatch != (Entity) null)
      {
        UI.Notify("Delete");
        this.ClosedHatch.HasCollision = false;
        this.ClosedHatch.IsVisible = false;
      }
      if ((double) World.GetDistance(Game.Player.Character.Position, this.MenuMarker) < 2.0 && Game.IsControlJustPressed(2, GTA.Control.Context) && this.isInInterior)
      {
        this.LoadIniFile("scripts//HKH191sBusinessMods//DoomsdayBusiness//Main.ini");
        if (!this.mainMenu.Visible)
        {
      ...
      if ((double) World.GetDistance(Game.Player.Character.Position, this.SourcingMenu) < 2.0 && Game.IsControlJustPressed(2, GTA.Control.Context) && this.isInInterior)
      {
        this.LoadIniFile("scripts//HKH191sBusinessMods//DoomsdayBusiness//Main.ini");
      ...
      {
        if (Game.IsControlJustPressed(2, GTA.Control.Cover) && !this.GarageMenu.Visible)
          this.GarageMenu.Visible = !this.GarageMenu.Visible;
        if (!Game.IsControlJustPressed(2, GTA.Control.Context) || this.purchaselvl < 1 || !((Entity) Game.Player.Character.CurrentVehicle == (Entity) null))
          return;
        this.RefreshInterior();
        this.LoadIniFile("scripts//HKH191sBusinessMods//DoomsdayBusiness//Main.ini");
        this.DeleteVehicles();
        ...
        Game.FadeScreenOut(300);
        Script.Wait(300);
        this.createdVehicles = true;
        this.isInInterior = true;
        Game.Player.Character.Position = this.Exit;
        Game.FadeScreenIn(900);
        if ((Entity) this.AkulaV != (Entity) null)
          this.AkulaV.IsInvincible = false;
        if ((Entity) this.AvengerV != (Entity) null)
          this.AvengerV.IsInvincible = false;
        if ((Entity) this.ThrusterV != (Entity) null)
          this.ThrusterV.IsInvincible = false;
      }
      else if ((double) World.GetDistance(Game.Player.Character.Position, this.Exit) >= 2.0)
        ;
    }
  }
}
