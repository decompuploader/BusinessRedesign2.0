...
namespace GunRunningBusiness
{
  public class AllStocks : Script
  {
    ...
    public AllStocks()
    {
      ...
      this.LoadIniFile2("scripts//HKH191sBusinessMods//GunRunningBusiness//Main.ini");
      this.LoadIniFile("scripts//HKH191sBusinessMods//GunRunningBusiness//Main.ini");
      UI.Notify("~o~Gunrunning Business~w~ Loaded, by ~g~HKH191~w~");
    ...
    private void OnTick(object sender, EventArgs e)
    {
      ...
      if (this.GetDay() == this.NextDay && this.GetMonth() == this.NextMonth)
      {
        ...
        })
        {
          ...
          if (AllStocks.\u003C\u003Eo__39.\u003C\u003Ep__0 == null)
          {
            // ISSUE: reference to a compiler-generated field
            AllStocks.\u003C\u003Eo__39.\u003C\u003Ep__0 = CallSite<Func<CallSite, object, string>>.Create(Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (string), typeof (AllStocks)));
          }
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          string str = AllStocks.\u003C\u003Eo__39.\u003C\u003Ep__0.Target((CallSite) AllStocks.\u003C\u003Eo__39.\u003C\u003Ep__0, obj);
          if (str != null)
          {
            this.LoadIniFile2("scripts//HKH191sBusinessMods//GunRunningBusiness//" + str);
        ...
        if (num < 500)
        {
          this.DecreaseGain("scripts//HKH191sBusinessMods//GunRunningBusiness//Main.ini");
          if (this.ShowStockIncrease)
          {
            if (!this.UseGlobalBusinessIncreaseDeceaseMessage)
              AllStocks.TextNotification("CHAR_LESTER", "~o~ Agent 14", "Gunrunning Business", "The Value of Stock has just Decreased for our Gunrunning Business");
            if (this.UseGlobalBusinessIncreaseDeceaseMessage)
        ...
        {
          this.IncreaseGain("scripts//HKH191sBusinessMods//GunRunningBusiness//Main.ini");
          if (this.ShowStockIncrease)
          {
            if (!this.UseGlobalBusinessIncreaseDeceaseMessage)
              AllStocks.TextNotification("CHAR_LESTER", "~o~ Agent 14", "Gunrunning Business", "The Value of Stock has just Increased for our Gunrunning Business");
            if (this.UseGlobalBusinessIncreaseDeceaseMessage)
              AllStocks.TextNotification("CHAR_LESTER", "~g~ Unknown", "All ~g~ HKH191's~w~ Business Mods", "The Value of Stock has just Increased/Decreased for our all Business");
          }
        }
    ...
    private void LoadIniFile(string iniName)
    {
      ...
      {
        UI.Notify("~r~Error~w~:AS Config.ini Failed To Load.");
      }
    }
