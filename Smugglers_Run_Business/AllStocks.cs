...
namespace Smuggler_s_Run_Business
{
  public class AllStocks : Script
  {
    ...
    public AllStocks()
    {
      ...
      this.LoadIniFile2("scripts//HKH191sBusinessMods//Smuggler's Run Business//Main.ini");
      this.LoadIniFile("scripts//HKH191sBusinessMods//Smuggler's Run Business//Main.ini");
      UI.Notify("~r~Smuggler's Run Business~w~ Loaded, by ~g~HKH191~w~");
    ...
    private void OnTick(object sender, EventArgs e)
    {
      ...
      })
      {
        ...
        if (AllStocks.\u003C\u003Eo__41.\u003C\u003Ep__0 == null)
        {
          // ISSUE: reference to a compiler-generated field
          AllStocks.\u003C\u003Eo__41.\u003C\u003Ep__0 = CallSite<Func<CallSite, object, string>>.Create(Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (string), typeof (AllStocks)));
        }
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if (AllStocks.\u003C\u003Eo__41.\u003C\u003Ep__0.Target((CallSite) AllStocks.\u003C\u003Eo__41.\u003C\u003Ep__0, obj) != null)
        {
          this.LoadIniFile2("scripts//HKH191sBusinessMods//Smuggler's Run Business//Main.ini");
          if (this.Config.GetValue<int>("Setup", "BuisnessLevel", this.purchaselvl) >= 1)
          {
      ...
      if (num < 500)
      {
        this.DecreaseGain("scripts//HKH191sBusinessMods//Smuggler's Run Business//Main.ini");
        if (!this.ShowStockIncrease)
          return;
        if (!this.UseGlobalBusinessIncreaseDeceaseMessage)
          AllStocks.TextNotification("CHAR_Ron", "~r~ Ron", "Smuggler's Run Business", "The Value of Stock has just Decreased for our Smuggler's Run Business");
        if (!this.UseGlobalBusinessIncreaseDeceaseMessage)
          return;
      ...
      else
      {
        if (num < 500)
          return;
        this.IncreaseGain("scripts//HKH191sBusinessMods//Smuggler's Run Business//Main.ini");
        if (!this.ShowStockIncrease)
          return;
        if (!this.UseGlobalBusinessIncreaseDeceaseMessage)
          AllStocks.TextNotification("CHAR_Ron", "~r~ Ron", "Smuggler's Run Business", "The Value of Stock has just Increased for our Smuggler's Run Business");
        if (!this.UseGlobalBusinessIncreaseDeceaseMessage)
          return;
        AllStocks.TextNotification("CHAR_LESTER", "~g~ Unknown", "All ~g~ HKH191's~w~ Business Mods", "The Value of Stock has just Increased/Decreased for our all Business");
      }
    ...
    private void LoadIniFile2(string iniName)
    {
      ...
      {
        UI.Notify("~r~Error~w~: 6 Config.ini Failed To Load.");
      }
    }
    ...
    private void LoadIniFile(string iniName)
    {
      ...
      {
        UI.Notify("~r~Error~w~: 7 Config.ini Failed To Load.");
      }
    }
  }
}
