...
namespace ExecutiveBusiness
{
  public class SaveCar : Script
  {
    ...
    public float MOC_Vehicle_Heading;
    ...
    public string GrabCarName(string iniName)
    {
      Script.Wait(1);
      this.LoadIniFile(iniName);
      this.VehicleNameHash = this.Config.GetValue<GTA.Native.VehicleHash>("Configurations", "VehicleNameHash", this.VehicleNameHash);
      ...
      if (!this.VehicleName.Equals("null"))
      {
        str = this.VehicleName;
        model = new Model(this.VehicleName);
        model.Request(250);
        if (!model.IsValid && (this.VehicleNameHash != (GTA.Native.VehicleHash) 4294967295 || this.VehicleNameHash != (GTA.Native.VehicleHash) 0))
        {
          string vehicleName = this.VehicleName;
          model = new Model(this.VehicleNameHash);
          model.Request(250);
          if (!model.IsValid && !this.VehicleName.Equals("null"))
          {
    ...
    public void SaveWithoutDelete()
    {
      ...
      if (Game.Player.Character.CurrentVehicle.IsPrimaryColorCustom)
      {
        ...
        strArray[0] = "Color [A = 255, R = ";
        num = customPrimaryColor.R;
        strArray[1] = num.ToString();
        strArray[2] = ", G = ";
        num = customPrimaryColor.G;
        strArray[3] = num.ToString();
        strArray[4] = ", B = ";
        num = customPrimaryColor.B;
        strArray[5] = num.ToString();
        strArray[6] = "]";
        string str = string.Concat(strArray);
        config.SetValue<string>("Configurations", "CustomPrimaryColor", str);
        this.Config.Save();
      }
      if (!Game.Player.Character.CurrentVehicle.IsPrimaryColorCustom)
      {
      ...
      if (Game.Player.Character.CurrentVehicle.IsSecondaryColorCustom)
      {
        ...
        string[] strArray = new string[7];
        strArray[0] = "Color [A = 255, R = ";
        num = customSecondaryColor.R;
        strArray[1] = num.ToString();
        strArray[2] = ", G = ";
        num = customSecondaryColor.G;
        strArray[3] = num.ToString();
        strArray[4] = ", B = ";
        num = customSecondaryColor.B;
        strArray[5] = num.ToString();
        strArray[6] = "]";
        string str = string.Concat(strArray);
        config.SetValue<string>("Configurations", "CustomSecondaryColor", str);
        this.Config.Save();
      }
      if (!Game.Player.Character.CurrentVehicle.IsSecondaryColorCustom)
      {
    ...
    public void Save()
    {
      ...
      if (Game.Player.Character.CurrentVehicle.IsPrimaryColorCustom)
      {
        ...
        string[] strArray = new string[7];
        strArray[0] = "Color [A = 255, R = ";
        num1 = customPrimaryColor.R;
        strArray[1] = num1.ToString();
        strArray[2] = ", G = ";
        num1 = customPrimaryColor.G;
        strArray[3] = num1.ToString();
        strArray[4] = ", B = ";
        num1 = customPrimaryColor.B;
      ...
      if (Game.Player.Character.CurrentVehicle.IsSecondaryColorCustom)
      {
        ...
        string[] strArray = new string[7];
        strArray[0] = "Color [A = 255, R = ";
        num1 = customSecondaryColor.R;
        strArray[1] = num1.ToString();
        strArray[2] = ", G = ";
        num1 = customSecondaryColor.G;
        strArray[3] = num1.ToString();
        strArray[4] = ", B = ";
        num1 = customSecondaryColor.B;
        strArray[5] = num1.ToString();
        strArray[6] = "]";
        string str = string.Concat(strArray);
        config.SetValue<string>("Configurations", "CustomSecondaryColor", str);
      ...
      if (Game.Player.Character.CurrentVehicle.IsPrimaryColorCustom)
      {
        ...
        string[] strArray = new string[7];
        strArray[0] = "Color [A = 255, R = ";
        num2 = customPrimaryColor.R;
        strArray[1] = num2.ToString();
        strArray[2] = ", G = ";
        num2 = customPrimaryColor.G;
        strArray[3] = num2.ToString();
        strArray[4] = ", B = ";
        num2 = customPrimaryColor.B;
      ...
      if (Game.Player.Character.CurrentVehicle.IsSecondaryColorCustom)
      {
        ...
        string[] strArray = new string[7];
        strArray[0] = "Color [A = 255, R = ";
        num2 = customSecondaryColor.R;
        strArray[1] = num2.ToString();
        strArray[2] = ", G = ";
        num2 = customSecondaryColor.G;
        strArray[3] = num2.ToString();
        strArray[4] = ", B = ";
        num2 = customSecondaryColor.B;
        strArray[5] = num2.ToString();
        strArray[6] = "]";
        string str = string.Concat(strArray);
        config.SetValue<string>("Configurations", "CustomSecondaryColor", str);
